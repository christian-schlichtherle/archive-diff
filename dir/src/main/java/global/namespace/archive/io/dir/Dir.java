...
public class Dir {
    ...
    public static ArchiveFileStore<Path> dir(File directory) {
        return dir(directory.toPath());
    }

    /** Returns an archive file store for the given directory. */
    public static ArchiveFileStore<Path> dir(final Path directory) {
        return new ArchiveFileStore<Path>() {
            ...
            ArchiveEntrySource<Path> pathSource(String relativePath) {
            ...
            ArchiveEntrySink<Path> pathSink(String relativePath) {
            ...
            Path resolve(String relativePath) { return directory.resolve(relativePath); }
        };
    }
}
