...
/**
 * An abstraction for safe reading of archive entries without leaking resources.
 * An archive file source provides a {@linkplain #input() socket} for safe access to an
 * {@link ArchiveFileInput}.
 *
